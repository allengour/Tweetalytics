...
class MyStreamer(TwythonStreamer):
    ...
    def store_json(self):
        ...
        with open('/home/ec2-user/project1/tweets_lyft/{}-{}-{}-{}-{}.json'.format(now.year, now.month, now.day, now.hour, keyword), 'w') as f:
...
if __name__ == '__main__':
    ...
    with open('/home/ec2-user/project1/twitter_credentials.json', 'r') as f:
